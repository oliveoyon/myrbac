...
class LsidRegisterController extends Controller
{
    ...
    public const SERVICE_TYPE_OPTIONS = [
        ...
        'Case related Information' => 'মামলা সংক্রান্ত (Case related Information)',
    ...
    private function normalizeLsidServiceTypes(?string $value): array
    {
        return $this->normalizeLsidMultiValue($value, [
            ...
            'case related information' => 'Case related Information',
            'case related' => 'Case related Information',
            'case information' => 'Case related Information',
            'মামলা সংক্রান্ত' => 'Case related Information',
