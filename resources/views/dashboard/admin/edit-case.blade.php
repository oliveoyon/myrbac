                        ...
                        <div id="collapseFourteen" class="accordion-collapse collapse" aria-labelledby="headingFourteen"
                            ...
                            <div class="accordion-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4" id="prison_legal_representation_details_field" style="{{ old('prison_legal_representation', $caseData->prison_legal_representation ?? '') == 'Other' ? '' : 'display:none' }}">
