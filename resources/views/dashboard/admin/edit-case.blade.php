        ...
        <div class="container-fluid case-form-shell">
            ...
            <form method="post" action="{{ route('editformaction') }}" enctype="multipart/form-data">
                ...
                <div class="case-form-hero">
                    <div>
                        <span class="case-kicker">Case edit</span>
                        <h2>Court-Police-Prison Form</h2>
                        <p class="case-form-meta">
                            <span>Central ID: {{ $caseData->central_id ?? 'N/A' }}</span>
                            <span>Institute: {{ $caseData->institute ?? 'N/A' }}</span>
                            <span>Name: {{ $caseData->full_name ?? 'N/A' }}</span>
                        </p>
                    </div>
                    <div class="case-status-pill">
                        Status:
                        @if ((int) $caseData->status === 1)
                            Submitted
                        @elseif ((int) $caseData->status === 2)
                            Verified by DPO
                        @elseif ((int) $caseData->status === 3)
                            Verified by MNEO
                        @else
                            N/A
                        @endif
                ...
                <div class="accordion" id="caseFormAccordion">
                            ...
                            <div class="accordion-body">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-3" id="child_2_sex" style="display: {{ old('children_with_prisoner', $caseData->children_with_prisoner ?? '') == 'Yes' ? 'block' : 'none' }};">
                                            ...
                                            <select class="form-select" id="child_2_sex_input" name="child_2_sex">
                                                <option value="">Select</option>
                                                <option value="Male" {{ old('child_2_sex', $caseData->child_2_sex ?? '') == 'Male' ? 'selected' : '' }}>Male</option>
                                                <option value="Female" {{ old('child_2_sex', $caseData->child_2_sex ?? '') == 'Female' ? 'selected' : '' }}>Female</option>
                                                <option value="Transgender" {{ old('child_2_sex', $caseData->child_2_sex ?? '') == 'Transgender' ? 'selected' : '' }}>Transgender</option>
                                            </select>
                                        </div>

                                        <div class="col-md-3" id="child_2_age" style="display: {{ old('children_with_prisoner', $caseData->children_with_prisoner ?? '') == 'Yes' ? 'block' : 'none' }};">
                                            ...
                                            <input type="number" class="form-control" id="child_2_age_input" name="child_2_age"
                                                value="{{ old('child_2_age', $caseData->child_2_age ?? '') }}">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                            ...
                            <div class="accordion-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4 guardian-field" id="guardian_relation_details_field" style="{{ in_array(old('guardian_relation', $caseData->guardian_relation ?? ''), ['Family Member', 'Relative', 'Other']) ? '' : 'display:none' }}">
                                        ...
                                        <input type="text" class="form-control" id="guardian_relation_details" name="guardian_relation_details"
                                            value="{{ old('guardian_relation_details', $caseData->guardian_relation_details ?? '') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                            ...
                            <div class="accordion-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4 lawyer-field" id="lawyer_type_details_field" style="{{ old('lawyer_type', $caseData->lawyer_type ?? '') == 'Other' ? '' : 'display:none' }}">
                                        ...
                                        <input type="text" class="form-control" id="lawyer_type_details" name="lawyer_type_details"
                                            value="{{ old('lawyer_type_details', $caseData->lawyer_type_details ?? '') }}">
                                    </div>
                        ...
                        <div id="collapseEight" class="accordion-collapse collapse" aria-labelledby="headingEight"
                            ...
                            <div class="accordion-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4" id="legal_representation_details_field" style="{{ in_array(old('legal_representation', $caseData->legal_representation ?? ''), ['NGO Panel Lawyer', 'Other']) ? '' : 'display:none' }}">
                                        ...
                                        <input type="text" class="form-control" id="legal_representation_details" name="legal_representation_details"
                                            value="{{ old('legal_representation_details', $caseData->legal_representation_details ?? '') }}">
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="date" class="form-control" id="identify_sureties_date"
                                            name="identify_sureties_date" value="{{ old('identify_sureties_date', $caseData->identify_sureties_date ?? '') }}">
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select" id="referral_service" name="referral_service">
                                            ...
                                            <option value="Other" {{ $caseData->referral_service == 'Other' ? 'selected' : '' }}>Other</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4" id="referral_service_details_field" style="{{ in_array(old('referral_service', $caseData->referral_service ?? ''), ['NGOs/RJ/Mediation', 'Other']) ? '' : 'display:none' }}">
                                        ...
                                        <input type="text" class="form-control" id="referral_service_details"
                                            name="referral_service_details" value="{{ old('referral_service_details', $caseData->referral_service_details ?? '') }}">
                                    </div>
                            ...
                            <div class="accordion-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="date" class="form-control" id="case_resolved_date" name="case_resolved_date"
                                            value="{{ old('case_resolved_date', $caseData->case_resolved_date ?? '') }}">
                                    </div>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input type="text" class="form-control" id="other_result_details" name="other_result_details"
                                            value="{{ old('other_result_details', $caseData->other_result_details ?? '') }}">
                                    </div>

                                    <div class="col-md-4">
                                        <label for="other_result_date" class="form-label">Date</label>
                                        <input type="date" class="form-control" id="other_result_date" name="other_result_date"
                                            value="{{ old('other_result_date', $caseData->other_result_date ?? '') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="collapseTwelve" class="accordion-collapse collapse" aria-labelledby="headingTwelve"
                            ...
                            <div class="accordion-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4" id="source_of_interview_details_field" style="{{ old('source_of_interview', $caseData->source_of_interview ?? '') == 'Other' ? '' : 'display:none' }}">
                                        ...
                                        <input type="text" class="form-control" id="source_of_interview_details" name="source_of_interview_details"
                                            value="{{ old('source_of_interview_details', $caseData->source_of_interview_details ?? '') }}">
                                    </div>
                                    <div class="col-md-4">
                        ...
                        <div id="collapseThirteen" class="accordion-collapse collapse" aria-labelledby="headingThirteen"
                            ...
                            <div class="accordion-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4" id="special_condition_details_field" style="{{ old('special_condition', $caseData->special_condition ?? '') == 'Other' ? '' : 'display:none' }}">
                                        ...
                                        <input type="text" class="form-control" id="special_condition_details" name="special_condition_details"
                                            value="{{ old('special_condition_details', $caseData->special_condition_details ?? '') }}">
                                    </div>
                        ...
                        <div id="collapseFourteen" class="accordion-collapse collapse" aria-labelledby="headingFourteen"
                            ...
                            <div class="accordion-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4" id="prison_legal_representation_details_field" style="{{ in_array(old('prison_legal_representation', $caseData->prison_legal_representation ?? ''), ['NGO Panel Lawyer', 'Other']) ? '' : 'display:none' }}">
                                        ...
                                        <input type="text" class="form-control" id="prison_legal_representation_details" name="prison_legal_representation_details"
                                            value="{{ old('prison_legal_representation_details', $caseData->prison_legal_representation_details ?? '') }}">
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="date" class="form-control" id="identify_sureties_prison_date" name="identify_sureties_prison_date" value="{{ old('identify_sureties_prison_date', $caseData->identify_sureties_prison_date ?? '') }}">
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="ministerial_communication_details" name="ministerial_communication_details" value="{{ old('ministerial_communication_details', $caseData->ministerial_communication_details ?? '') }}">
                                    </div>
                                    ...
                                    <div class="col-md-4" id="other_legal_assistance_details_field" style="{{ old('other_legal_assistance', $caseData->other_legal_assistance ?? '') == 'other' ? '' : 'display:none' }}">
                                        ...
                                        <input type="text" class="form-control" id="other_legal_assistance_details" name="other_legal_assistance_details"
                                            value="{{ old('other_legal_assistance_details', $caseData->other_legal_assistance_details ?? '') }}">
                                    </div>
                        ...
                        <div id="collapseFifteen" class="accordion-collapse collapse" aria-labelledby="headingFifteen"
                            ...
                            <div class="accordion-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4" id="send_to_details_field" style="{{ old('send_to', $caseData->send_to ?? '') == 'Other' ? '' : 'display:none' }}">
                                        ...
                                        <input type="text" class="form-control" id="send_to_details" name="send_to_details"
                                            value="{{ old('send_to_details', $caseData->send_to_details ?? '') }}">
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="convicted_length_details" name="convicted_length_details"
                                            value="{{ old('convicted_length_details', $caseData->convicted_length_details ?? '') }}">
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="convicted_sentence_expire_details" name="convicted_sentence_expire_details"
                                            value="{{ old('convicted_sentence_expire_details', $caseData->convicted_sentence_expire_details ?? '') }}">
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="date" class="form-control" id="result_of_appeal_date" name="result_of_appeal_date"
                                            value="{{ old('result_of_appeal_date', $caseData->result_of_appeal_date ?? '') }}">
                                    </div>
                                    <div class="col-md-4">
                                        <label for="prison_case_resolved_date" class="form-label">Case Resolved</label>
                                        <input type="date" class="form-control" id="prison_case_resolved_date" name="prison_case_resolved_date"
                                            value="{{ old('prison_case_resolved_date', $caseData->prison_case_resolved_date ?? '') }}">
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <div class="accordion-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        @php
                                            $selectedTypeServices = old('type_of_service', $caseData->type_of_service_list ?? []);
                                            $selectedTypeServices = is_array($selectedTypeServices) ? $selectedTypeServices : [$selectedTypeServices];
                                        @endphp
                                        <select class="form-select" id="type_of_service" name="type_of_service[]" multiple size="4">
                                            <option value="Legal Advice" {{ in_array('Legal Advice', $selectedTypeServices) ? 'selected' : '' }}>Legal Advice</option>
                                            <option value="Alternate Dispute Resolution" {{ in_array('Alternate Dispute Resolution', $selectedTypeServices) ? 'selected' : '' }}>Alternate Dispute Resolution</option>
                                            <option value="Filing New Lawsuit" {{ in_array('Filing New Lawsuit', $selectedTypeServices) ? 'selected' : '' }}>Filing New Lawsuit</option>
                                            <option value="Legal Aid in Existing Case" {{ in_array('Legal Aid in Existing Case', $selectedTypeServices) ? 'selected' : '' }}>Legal Aid in Existing Case</option>
                                        </select>
                                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingFileClosure">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                data-bs-target="#collapseFileClosure" aria-expanded="false" aria-controls="collapseFileClosure">
                                16. File Closure
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseSeventeen" class="accordion-collapse collapse {{ $errors->has('intervention_taken') || $errors->has('intervention_taken_date') || $errors->has('intervention_to_be_taken') || $errors->has('to_be_taken_date') ? 'show' : '' }}" aria-labelledby="headingSeventeen"
                            data-bs-parent="#caseFormAccordion">
                            <div class="accordion-body">
                                <div class="row g-3">
                                    <!-- Intervention Taken -->
                                    <div class="col-md-12">
                                        <label for="intervention_taken" class="form-label">Intervention Taken <span class="text-danger">*</span></label>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const child2Sex = document.getElementById('child_2_sex');
        const child2Age = document.getElementById('child_2_age');
        ...
        childrenWithPrisoner.addEventListener('change', function () {
            ...
            child2Sex.style.display = show ? 'block' : 'none';
            child2Age.style.display = show ? 'block' : 'none';
        });
    });

document.addEventListener("DOMContentLoaded", function () {
        let hasGuardian = document.getElementById("has_guardian");
        let guardianRelation = document.getElementById("guardian_relation");
        let guardianRelationDetails = document.getElementById("guardian_relation_details_field");
        ...
        function toggleGuardianFields() {
            ...
            if (guardianRelationDetails) {
                const showDetails = hasGuardian.value === "Yes" && ["Family Member", "Relative", "Other"].includes(guardianRelation.value);
                guardianRelationDetails.style.display = showDetails ? "block" : "none";
            }
        }

        hasGuardian.addEventListener("change", toggleGuardianFields);
        guardianRelation.addEventListener("change", toggleGuardianFields);
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        let lawyerType = document.getElementById("lawyer_type");
        let lawyerTypeDetails = document.getElementById("lawyer_type_details_field");
        ...
        function toggleLawyerFields() {
            ...
            if (lawyerTypeDetails) {
                const showDetails = hasLawyer.value === "Yes" && lawyerType.value === "Other";
                lawyerTypeDetails.style.display = showDetails ? "block" : "none";
            }
        }
    
        hasLawyer.addEventListener("change", toggleLawyerFields);
        lawyerType.addEventListener("change", toggleLawyerFields);
