    ...
    <section>
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="card-header mt-3 text-bg-dark d-flex justify-content-between align-items-center rounded">
                <h5 class="card-title ">Filter Interventions</h5>
