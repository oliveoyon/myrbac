...
<form id="pdfPostForm" method="POST" action="{{ route('generate-pdf-chart', [], false) }}" target="pdfFrame" class="d-none">
    ...
    <input type="hidden" name="title" value="District Wise Summery">
    <input type="hidden" name="orientation" value="P">
    <input type="hidden" name="fname" value="District Wise Summery.pdf">
...
<script>
    $('#printButton').on('click', function(event) {
        ...
        var chartCanvas = document.getElementById('districtBarChart');
