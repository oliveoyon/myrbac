            ...
            <div class="col-md-12">
                ...
                <div class="card-header text-bg-dark d-flex justify-content-between align-items-center">
                    ...
                    <div class="card-body table-responsive">
                        ...
                        <form method="GET" action="{{ route('pngo.summery') }}" class="summary-filter">
                            <div>
                            ...
                            <a href="{{ route('pngo.summery') }}" class="btn btn-outline-secondary btn-sm">Reset</a>
                        </form>
...
<script>
    $('#printButton').on('click', function(event) {
        ...
        modal.show();
        document.getElementById('pdfFrame').src = '{{ route('pngo.summery.print', [], false) }}' + window.location.search;
    });
</script>
